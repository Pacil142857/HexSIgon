...
derived_units = [
    ...
    ( 'Joule per Mole-Kelvin', 'J\n—————\nmol·K', 'Molar Entropy',  Hex(second = -2, meter = 2, kilogram = 1, ampere = 0, kelvin = -1, mole = -1, candela = 0)),
    ( 'Coulomb per Kilogram', 'C\n——\nkg', 'Exposure (X- and γ-Rays)', Hex(second = 1, meter = 0, kilogram = -1, ampere = 1, kelvin = 0, mole = 0, candela = 0)),
    ...
    ( 'Katal per Cubic Meter', 'kat\n———\nm³', 'Catalytic Activity Concentration', Hex(second = -1, meter = -3, kilogram = 0, ampere = 0, kelvin = 0, mole = 1, candela = 0)),
]
