...
derived_units = [
    ...
    Unit( 'Volt', 'V', 'Electric Potential',  Hex(second = 1, meter = 2, kilogram = 1, ampere = -3, kelvin = -1, mole = 0, candela = 0)),
    Unit( 'Farad', 'F', 'Capacitance', Hex(second = 4, meter = -2, kilogram = -1, ampere = 2, kelvin = -2, mole = 0, candela = 0)),
    Unit( 'Ohm', 'Ω', 'Resistance',  Hex(second = -3, meter = 2, kilogram = 1, ampere = -2, kelvin = -1, mole = 0, candela = 0)),
    ...
    Unit( 'Watt per Square Meter', 'W/m²', 'Heat Flux Density',  Hex(second = -3, meter = -1, kilogram = 1, ampere = 0, kelvin = 0, mole = 0, candela = 0)),
    Unit( 'Joule per Kelvin', 'J/K', 'Entropy',  Hex(second = -2, meter = -2, kilogram = 1, ampere = 0, kelvin = -1, mole = 0, candela = 0)),
    Unit( 'Joule per Kilogram-Kelvin', 'J/(kg⋅K)', 'Specific Heat Capacity',  Hex(second = -2, meter = -2, kilogram = -1, ampere = 0, kelvin = -1, mole = 0, candela = 0)),
